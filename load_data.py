...
def main():
    ...
    with sqlite3.connect('databaseSchema.db') as conn:
        ...
        curr.execute("DROP TABLE IF EXISTS CellFrequency;")
        curr.execute("DROP TABLE IF EXISTS Sample;")
        curr.execute("DROP TABLE IF EXISTS Treatment;")
        curr.execute("DROP TABLE IF EXISTS Subject;")
